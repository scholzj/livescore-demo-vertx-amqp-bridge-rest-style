...
# Copy the binaries
cp -r -v ./target/vertx-amqp-bridge-rest-style-1.0-SNAPSHOT/vertx-amqp-bridge-rest-style-1.0-SNAPSHOT ./Dockerfile/vertx-amqp-bridge-rest-style-1.0-SNAPSHOT
